...
public class OpenTapsWrapperForTestNG {
...

	{
		...
		{
			System.out.println("Verify text contains by Xpath could not work due to browser has closed or the address in the URL is wrong");
		}
		catch (Exception exx)
		{
...

	{
		...
		{
			System.out.println("Verify text contains by"+ id+" could not work due to browser has closed or the address in the URL is wrong");
		}
		catch (Exception exx)
		{
	...
	public String  mouseoverMainMenuByXPath(String xpath){
		String text = null;
		try {
			WebElement menu = driver.findElementByXPath(xpath);
			Actions mouse = new Actions(driver);
			mouse.moveToElement(menu).clickAndHold().perform();
			System.out.println("Mouseover was completed on required menu");
			System.out.println(text);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			System.out.println("Entered xpath is not proper");
		} finally {
			takeScreenshot();
		}
		return text;
	...
	//mouse over  sub menu
	public String  mouseoverSubMenuByXPath(String xpath){
		String text = null;
		try {
			WebElement menu = driver.findElementByXPath(xpath);
			Actions mouse = new Actions(driver);
